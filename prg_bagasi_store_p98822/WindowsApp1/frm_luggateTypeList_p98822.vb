...
Public Class frm_luggateTypeList_p98822
    ...
    Private Sub RefreshGrid()
        Dim sql As String = "select * from tbl_type_p98822 "
    ...
    Private Sub UpdateProduct()
        Dim mysql As String = "update tbl_type_p98822 set " &
            "FLD_type_name = '" & txt_name.Text & "' " &
            "WHERE FLD_type_ID = " & txt_id.Text
    ...
    Private Sub AddNewProduct()
        Dim mysql As String = "insert into tbl_type_p98822 (FLD_type_name) values ('" &
            txt_name.Text & "')"
    ...
    Private Sub btn_delete_Click(sender As Object, e As EventArgs) Handles btn_delete.Click
        ...
        If delete_confirmation = MsgBoxResult.Yes Then
            run_command("delete from tbl_type_p98822 where fld_type_id = " & txt_id.Text & "")
