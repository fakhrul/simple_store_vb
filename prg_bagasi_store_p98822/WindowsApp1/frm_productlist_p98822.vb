...
Public Class frm_productlist_p98822
    ...
    Private Sub RefreshDefaultProducts()
        ...
        sql = "select P.fld_product_id, P.fld_product_name, P.fld_price,  B.fld_brand_name from tbl_product_p98822 as P, tbl_brand_p98822 as B where P.fld_brand = B.fld_brand_id"
